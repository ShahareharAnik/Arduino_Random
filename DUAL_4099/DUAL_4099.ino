    ...
    void loop ()  {     
      ...
      for (line = 0; line < 8 ; line++) {
        ...
        //.  Serial.println (" Inverter Capacity is available.. ") ;  
          ...
          //.  Serial.println (" Circuit already in inverter , operation skipped....");                                                     // ICC > 5% & Circuit on inverter & Circuit loaded..
                                                                // No action needed. 
...
// Function Definition Area // 
              ...
              float ScanLineLoad (int line) { // Start of ScanLineLoad () Function //
                  ...
                  //.  Serial.println ("           * * * *             Circuit Scanning in progress, please wait       * * * * ");
                    Serial.println ();
                    digitalWrite (11, line & 0x01); digitalWrite(12, (line & 0x02) >> 1); digitalWrite(13, (line & 0x04) >> 2); // Line selection
                  //.  delay (1000) ;
                  //.  Serial.print ("       Circuit No #  ");  Serial.print (line);
                    
                    LineLoad [line] = (scanBus(loadPin, 100) -2.50075 ) * 808.00 ; 
       ...
       float findUtilityLoad ()  {
        //. Serial.println (" Utility Bus ") ;
          float load ;
          load = (scanBus (A10, 200)-0.503424) * 2011.00  ;
          if ( load< 10.00 ) load = 0.00 ;
       ...
       float findInverterLoad () {
        ...
        //.  Serial.println (" Inverter Bus ") ;
          float load ;
          load = (scanBus (A9, 200)-0.503424) * 2011.00  ;
          if ( load< 10.00 ) load = 0.00 ;
      ...
      float scanBus ( int pin, int nos ) {  // Start of ScanInverterLoad () Function // 
            ...
            //  Serial.println (" Samples printing completed. "); 
             ...
             // if ( sample [0]<= 10.00 ) sample [0] = 0.00 ;
              // Serial.print ("  Peak Load (VA)=  \t"); Serial.println ( sample [0] ); 
              //  free (sample) ;   
